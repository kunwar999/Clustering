...
namespace cure_clustering
{
    public partial class PartitioningResults : Form
    {
        ...
        private void runSequentialQuery(StringBuilder query)
        {
            String query1 = query.ToString().Substring(query.ToString().IndexOf("AND")+3);
            String query2 = "SELECT * FROM " + GlobalVariables.tempTableName + " WHERE " + query1;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Merge merge = new Merge(this,setup);
            merge.Show();
            this.Hide();
        }
